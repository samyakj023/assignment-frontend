...
<div class="profile-sidebar jd-filters-container">
  <div class="MuiBox-root css-r7so2y">
    <div class="css-b62m3t-container">
      ...
      ></span>
      <div class="select__control css-5thazd-control">
        <div
          class="select__value-container select__value-container--is-multi css-hlgwow"
        >
          <div
            class="select__placeholder css-1r8plui-placeholder"
          ...
          <div class="select__input-container css-19bb58m" data-value="">
            <input
              ...
              aria-haspopup="true"
              role="combobox"
              aria-controls="react-select-2-list"
      ...
      <div><input name="colors" type="hidden" value="" /></div>
    </div>
  </div>
  <div class="MuiBox-root css-1yxoz1i">
        ...
        >
          ...
          <div class="select__input-container css-19bb58m" data-value="">
            <input
              ...
              aria-haspopup="true"
              role="combobox"
              aria-controls="react-select-2-list" // Add aria-controls attribute// Add aria-expanded attribute
              aria-activedescendant=""
  ...
  <div class="MuiBox-root css-1yxoz1i">
    <div class="basic-multi-select css-b62m3t-container">
      <span id="react-select-7-live-region" class="css-7pg0cj-a11yText"></span
      ><span
        aria-live="polite"
        aria-atomic="false"
        aria-relevant="additions text"
